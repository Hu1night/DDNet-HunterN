#include "jojohammer.h"
#include <game/generated/server_data.h>
#include <game/server/entities/projectile.h>

CJOJOHammer::CJOJOHammer(CCharacter *pOwnerChar) :
	CWeapon(pOwnerChar)
{
...
void CJOJOHammer::Fire(vec2 Direction)
{
	...
	Character()->Controller()->DoPause(IGameController::TIMER_INFINITE);
	...
	for(int i = 0; i < Num; ++i)
	{
		...
		Character()->Controller()->DoPause(0);
